...
public final class AExpressoesExpressaoRelacional extends PExpressaoRelacional
{
    private PExpressaoAritmetica _expressaoAritmetica_;

    public AExpressoesExpressaoRelacional()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpressoesExpressaoRelacional(
    ...
    {
        ((Analysis) sw).caseAExpressoesExpressaoRelacional(this);
    }
