...
public final class AMenorQOperadorRelacional extends POperadorRelacional
{
    private TMenorQ _menorQ_;

    public AMenorQOperadorRelacional()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMenorQOperadorRelacional(
    ...
    {
        ((Analysis) sw).caseAMenorQOperadorRelacional(this);
    }
