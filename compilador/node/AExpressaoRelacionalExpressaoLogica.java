...
public final class AExpressaoRelacionalExpressaoLogica extends PExpressaoLogica
{
    private PExpressaoRelacional _expressaoRelacional_;

    public AExpressaoRelacionalExpressaoLogica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpressaoRelacionalExpressaoLogica(
    ...
    {
        ((Analysis) sw).caseAExpressaoRelacionalExpressaoLogica(this);
    }
